...
privileged aspect VoteController_Roo_Controller {
    ...
    @Autowired
    private GenericConversionService VoteController.conversionService;
    ...
    @PostConstruct
    void VoteController.registerConverters() {
    ...
    private String VoteController.encodeUrlPathSegment(String pathSegment, HttpServletRequest request) {
